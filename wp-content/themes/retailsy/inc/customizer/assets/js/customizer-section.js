...
function retailsyfrontpagesectionsscroll( section_id ){
 ...
 jQuery('body').on('click', '#sub-accordion-panel-retailsy_frontpage_sections .control-subsection .accordion-section-title', function(event) {
        var section_id = jQuery(this).parent('.control-subsection').attr('id');
        retailsyfrontpagesectionsscroll( section_id );
});