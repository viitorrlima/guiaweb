 ...
 */
function retailsy_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function retailsy_sanitize_html( $html ) {
 ...
 */
function retailsy_sanitize_number_absint( $number, $setting ) {
 ...
 */
function retailsy_sanitize_select( $input, $setting ) {
 ...
 */
function retailsy_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function retailsy_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function retailsy_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}