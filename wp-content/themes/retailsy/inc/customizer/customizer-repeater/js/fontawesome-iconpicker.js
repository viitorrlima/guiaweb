(function ($) {
    ...
    wp.retailsycustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                retailsy_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.retailsycustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.retailsycustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.retailsycustomizerRepeater.iconPickerToggle($(this));
        });
